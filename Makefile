...
define PLEXFLIX_DOCKER_COMPOSE_ARGS
	...
	-f ${PLEXFLIX_DOCKER_COMPOSE_COMMON_FILE} \
	-f ${PLEXFLIX_DOCKER_COMPOSE_HELPERS_FILE} \
	-f ${PLEXFLIX_DOCKER_COMPOSE_PLEX_FILE} \
	-f ${PLEXFLIX_DOCKER_COMPOSE_PLEXDRIVE_FILE} \
	-p $(PLEXFLIX_PROJECT_NAME)
endef
